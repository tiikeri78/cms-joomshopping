...
* указать [архив](https://github.com/yoomoney/yoomoney-cms-v2-joomshopping/blob/master/yoomoney-cms-v2-joomshopping.zip?raw=true) в качестве файла пакета обновления
...
Для использования нужно [подключиться к Яндекс.Кассе](https://yookassa.ru/joinups) и получить в личном кабинете на сайте Кассы параметры **shopId** и **Секретный ключ**.
