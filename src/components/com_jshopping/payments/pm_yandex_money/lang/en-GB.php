...
define('_JSHOP_YM_DESCRIPTION_HELP', 'Full data on the transaction can be found in your Yandex.Checkout Merchant Profile, the user will see it during the checkout process. Limitations: no more than 128 symbols.');
