...
define('_JSHOP_YOO_LICENSE_TEXT',"Для работы с модулем нужно подключить магазин к <a target=\"_blank\" href=\"https://yookassa.ru/\">Яндекс.Кассе</a>.");
define('_JSHOP_YOO_VERSION_DESCRIPTION','Версия модуля ');

define('_JSHOP_YOO_TAB_MONEY', 'Яндекс.Деньги');
define('_JSHOP_YOO_TAB_KASSA', 'Яндекс.Касса');
define('_JSHOP_YOO_TAB_PAYMENTS', 'Платежка');

define('_JSHOP_YOO_KASSA_ON', 'Включить приём платежей через Яндекс.Кассу');
define('_JSHOP_YOO_KASSA_TEST', 'Тестовый режим');
define('_JSHOP_YOO_KASSA_WORK', 'Реальный режим');
define('_JSHOP_YOO_KASSA_HELP_CHECKURL', 'Этот адрес понадобится, только если его попросят специалисты Яндекс.Кассы');
define('_JSHOP_YOO_KASSA_HELP_SUCCESSURL', 'Включите «Использовать страницы успеха и ошибки с динамическими адресами» в настройках личного кабинета Яндекс.Кассы');
define('_JSHOP_YOO_KASSA_HELP_DYNAMICURL', 'Страницы с динамическими адресами');

define('_JSHOP_YOO_KASSA_HEAD_LK', 'Параметры из личного кабинета Яндекс.Кассы');
define('_JSHOP_YOO_KASSA_SHOP_ID_LABEL', 'shopId');
define('_JSHOP_YOO_KASSA_SHOP_ID_DESCRIPTION', 'Скопируйте shopId из личного кабинета Яндекс.Кассы');
define('_JSHOP_YOO_KASSA_PASSWORD_LABEL', 'Секретный ключ');
define('_JSHOP_YOO_KASSA_PASSWORD_DESCRIPTION', 'Выпустите и активируйте секретный ключ в личном кабинете Яндекс.Кассы. Потом скопируйте его сюда.');
define('_JSHOP_YOO_KASSA_PARAMS', 'Shop ID, scid, ShopPassword можно посмотреть в <a href=\'https://yookassa.ru/joinups\' target=\'_blank\'>личном кабинете</a> после подключения Яндекс.Кассы.');

define('_JSHOP_YOO_KASSA_PAYMODE_HEAD', 'Настройка сценария оплаты');
define('_JSHOP_YOO_KASSA_PAYMODE_LABEL', 'Выбор способа оплаты');
define('_JSHOP_YOO_KASSA_SEND_RECEIPT_LABEL', 'Отправлять в Яндекс.Кассу данные для чеков (54-ФЗ)');
...
define('_JSHOP_YOO_DESCRIPTION_HELP', 'Это описание транзакции, которое пользователь увидит при оплате, а вы — в личном кабинете Яндекс.Кассы. Например, «Оплата заказа №72».<br>
...
define('_JSHOP_YOO_HOLD_MODE_CAPTURE_PAYMENT_SUCCESS', 'Вы подтвердили платёж в Яндекс.Кассе.');
define('_JSHOP_YOO_HOLD_MODE_CAPTURE_PAYMENT_FAIL', 'Платёж не подтвердился. Попробуйте ещё раз.');
define('_JSHOP_YOO_HOLD_MODE_CANCEL_PAYMENT_SUCCESS', 'Вы отменили платёж в Яндекс.Кассе. Деньги вернутся клиенту.');
...
define('_JSHOP_YOO_KASSA_SELECT_TEXT', 'Отметьте способы оплаты, которые указаны в вашем договоре с Яндекс.Деньгами');
define('_JSHOP_YOO_KASSA_CREDENTIALS_ERROR', 'Проверьте shopId и Секретный ключ — где-то есть ошибка. А лучше скопируйте их прямо из <a href="https://yookassa.ru/my" target="_blank">личного кабинета Яндекс.Кассы</a>');
...
define('_JSHOP_YOO_METHOD_YOOMONEY_DESCRIPTION', 'Яндекс.Деньги');
...
define('_JSHOP_YOO_METHOD_WIDGET_DESCRIPTION', 'Платёжный виджет Кассы (карты, Apple Pay и Google Pay)');
...
define('_JSHOP_YOO_METHOD_YOOMONEY_DESCRIPTION_PUBLIC', 'Яндекс.Деньги');
...
define('_JSHOP_YOO_MONEY_HEAD', 'Для работы с модулем нужно <a href="https://yoomoney.ru/new" target="_blank">открыть кошелек</a> на Яндексе и
					<a href="https://yoomoney.ru/transfer/myservices/http-notification" target="_blank">зарегистрировать приложение</a> на сайте Яндекс.Денег');
define('_JSHOP_YOO_MONEY_ON', 'Включить прием платежей в кошелек на Яндексе');
...
define('_JSHOP_YOO_METHOD_YM2_DESCRIPTION', 'Кошелек Яндекс.Деньги');
define('_JSHOP_YOO_METHOD_CARDS2_DESCRIPTION', 'Банковская карта');

define('_JSHOP_YOO_METHOD_YM2_DESCRIPTION_PUBLIC', 'Кошелек Яндекс.Деньги');
...
define('_JSHOP_YOO_PAYMENTS_HEAD', 'Это платежная форма на ваш сайт. Позволяет принимать платежи на счет компании — с
карт и из кошельков Яндекс.Денег, без договора.<br />
Для настройки нужен ID формы: он придет в письме, когда вы
<a href="https://yoomoney.ru/fastpay/" target="_blank">соберете форму в конструкторе</a>.');
...
define('_JSHOP_YOO_MODE1_DESCRIPTION', 'Яндекс.Денеги');
define('_JSHOP_YOO_MODE2_DESCRIPTION', 'Яндекс.Касса (выбор оплаты на стороне сайта)');
define('_JSHOP_YOO_MODE3_DESCRIPTION', 'Яндекс.Касса (выбор оплаты на стороне Яндекс.Кассы)');
define('_JSHOP_YOO_MODE4_DESCRIPTION', 'Платежка (банковские карты, кошелек)');
define('_JSHOP_YOO_REG_IND', 'Если у вас нет аккаунта в Яндекс-Деньги, то следует зарегистрироваться тут - <a href="https://yoomoney.ru/" target="_blank">https://yoomoney.ru/</a><br/><b>ВАЖНО!</b> Вам нужно будет указать ссылку для приема HTTP уведомлений здесь - <a href="https://sp-yoomoney.ru/myservices/online.xml">https://sp-yoomoney.ru/myservices/online.xml</a>');

define('_JSHOP_YOO_REG_ORG', 'Для работы с модулем необходимо <a href="https://yoomoney.ru/joinups/">подключить магазин к Яндек.Кассе</a>. После подключения вы получите параметры для приема платежей (идентификатор магазина — shopId и номер витрины — scid).');
...
define('_JSHOP_YOO_SHOPID', 'Идентификатор вашего магазина в Яндекс.Деньгах (ShopID):');
define('_JSHOP_YOO_SCID', 'Идентификатор витрины вашего магазина в Яндекс.Деньгах (scid):');
define('_JSHOP_YOO_PARAM', 'Название параметра');
define('_JSHOP_YOO_VALUE', 'Значение');
define('_JSHOP_YOO_RETURNURL', 'Динамический');
define('_JSHOP_YOO_ACCOUNT_DESCRIPTION', 'Номер кошелька Яндекс:');
...
define('_JSHOP_YOO_NOTIFICATION_URL_HELP_TEXT', 'Этот адрес понадобится, только если его попросят специалисты Яндекс.Кассы');
